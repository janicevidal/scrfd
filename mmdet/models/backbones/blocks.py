...
import numpy as np
from mmdet.models.backbones.dbb_transforms import transI_fusebn, transII_addbranch, transIII_1x1_kxk, transV_avg, transVI_multiscale
...
class OREPA(nn.Module):
    ...
    def weight_gen(self):
        ...
        weight = weight_orepa_origin + weight_orepa_avg + weight_orepa_1x1 + weight_orepa_1x1_kxk + weight_orepa_pfir
        return weight
